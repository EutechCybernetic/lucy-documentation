...
* [Dashboards](dashboards/README.md)
  * [Gallery](dashboards/gallery.md)
  * [Creating a Canvas on the Gallery](dashboards/creating-a-canvas-on-the-gallery.md)
  * [Editing Properties of a Canvas](dashboards/editing-properties-of-a-canvas.md)
  * [Searching and Viewing Your Canvases](dashboards/searching-and-viewing-your-canvases.md)
  * [Adding Widgets onto Your Canvas](dashboards/adding-widgets-onto-your-canvas.md)
  * [Customising User-created Widgets on a Canvas](dashboards/customising-user-created-widgets-on-a-canvas.md)
  * [Adjusting Widget Settings](dashboards/adjusting-widget-settings.md)
  * [Moving a Widget around a Canvas](dashboards/moving-a-widget-around-a-canvas.md)
  * [Resizing a Widget on a Canvas](dashboards/resizing-a-widget-on-a-canvas.md)
  * [Filtering Data in a Widget](dashboards/filtering-data-in-a-widget.md)
  * [Deleting a Widget from Your Canvas](dashboards/deleting-a-widget-from-your-canvas.md)
  * [Building a Widget from Your Canvas](dashboards/building-a-widget-from-your-canvas.md)
  * [Customising a Canvas](dashboards/customising-a-canvas.md)
...
* [User Interfaces](user-interfaces/README.md)
  * [Designing a User Interface](user-interfaces/designing-a-user-interface/README.md)
    ...
    * [Selecting a Widget Template](user-interfaces/designing-a-user-interface/selecting-a-widget-template.md)
  ...
  * [Saving a Widget as a Template](user-interfaces/saving-a-widget-as-a-template.md)
* [Workflows and Integrations](workflows-and-integrations/README.md)
  ...
  * [Automating Form Submission with Email Notification](workflows-and-integrations/automating-form-submission-with-email-notification.md)
  * [Automating Form Submission with Slack Notification](workflows-and-integrations/automating-form-submission-with-slack-notification.md)
